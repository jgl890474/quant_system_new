...
def 显示(引擎):
    ...
    颜色库 = [
        ...
        "#ec489a", "#14b8a6", "#f97316", "#6366f1", "#a855f7",
        "#22c55e", "#eab308", "#ef4444", "#84cc16", "#06b6d4"
    ]
    ...
    for 策略名 in 策略名称列表:
        收益率 = 策略收益率.get(策略名, 0)
        颜色 = 策略颜色映射.get(策略名, "#94a3b8")
        对比数据.append({
            " ": f"<span style='color:{颜色}; font-size:16px;'>●</span>",
            "策略名称": 策略名,
            "模拟收益率": f"{收益率:+.1f}%",
        })
